    ...
    <div class="container ">
        <div class="card">
            <div class="card-content">
                <div class="content">
                    <div
                        class="control is-flex is-flex-direction-column is-justify-content-center is-align-items-center has-text-centered">
                    ...
                    <form action="/profile" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control">
                            ...
                            <input class="input is-rounded" type="text" name="name" value="{{auth()->user()->name}}">
                            @error('name')
                        ...
                        <div class="control">
                            <label class="label my-3">email</label>

                            <input class="input is-rounded" type="email" name="email" value="{{auth()->user()->email}}">
                            @error('email')
                            <div class="has-text-danger">
                                <small>{{$message}}</small>
                            </div>
                        ...
                        <div class="control">
                            <label class="label my-3">password</label>
                        ...
                        <div class="control">
                            <label class="label my-3">re-type password</label>
